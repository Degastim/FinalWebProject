...
public class DrugDaoImpl implements DrugDao {
    ...
    private static final String SQL_ADD_DRUG = "INSERT INTO webdb.drugs(drug_name, amount, description, need_prescription) VALUES(?,?,?,?)";
    ...
    @Override
    public void updateDrug(int drugId, String drugName, BigDecimal drugAmount, String drugDescription, boolean needPrescription, int price, int dosage) throws DaoException {
        try (Connection connection = ConnectionPool.INSTANCE.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(SQL_UPDATE_DRUG)) {
            preparedStatement.setString(1, drugName);
            preparedStatement.setBigDecimal(2, drugAmount);
    ...
    public void deleteById(int drugId) throws DaoException {
        try (Connection connection = ConnectionPool.INSTANCE.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(SQL_DELETE_DRUG_BY_ID)) {
    ...
    @Override
    public void add(String drugName, int drugAmount, String drugDescription, boolean needPrescription) throws DaoException {
        try (Connection connection = ConnectionPool.INSTANCE.getConnection();
    ...
    @Override
    public boolean findNeedPrescriptionByDrugName(String drugName) throws DaoException {
        try (Connection connection = ConnectionPool.INSTANCE.getConnection();
