...
public class PrescriptionDao extends AbstractDao<Prescription> {
    ...
    private static final String SQL_UPDATE_BY_ID = "UPDATE webdb.prescriptions SET customer_id=?, doctor_id=?, prescription_drug_id=?, amount=?, issue_date=?, end_date=?, prescription_status_id=?";
