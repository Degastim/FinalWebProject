...
public class UserDao extends AbstractDao<User> {
    ...
    private static final String SQL_FIND_USER_BY_EMAIL_PASSWORD = "SELECT user_id, users.name, users.surname,roles.role, users.amount FROM webdb.users JOIN webdb.roles ON users.role_id=roles.role_id  where email=? and password=?";
