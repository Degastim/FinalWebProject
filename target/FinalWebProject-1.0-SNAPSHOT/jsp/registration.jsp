    ...
    <div class="col-md-4 mx-auto my-5">
        <form class="was-validated" method="POST" action="controller">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="userRole" value="customer" id="userRole1" required>
                <label class="form-check-label" for="userRole1"><fmt:message
                        key="registration.checkbox.customer"/></label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="userRole" value="doctor" id="userRole2" required>
                <label class="form-check-label" for="userRole2"><fmt:message
                        key="registration.checkbox.doctor"/></label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="userRole" value="pharmacist" id="userRole3" required>
                <label class="form-check-label" for="userRole3"><fmt:message
                        key="registration.checkbox.pharmacist"/></label>
            </div>
            <br>
            ...
            <br>
            <div>
                <button class="w-100 btn btn-md btn-primary" type="primary"><fmt:message
                        key="registration.button.submit"/></button>
            </div>
            <div>
                <button class="w-100 btn btn-md btn-success" type="submit"><fmt:message
                        key="registration.button.redirectToLogin"/></button>
            </div>
        </form>
    </div>
</div>
