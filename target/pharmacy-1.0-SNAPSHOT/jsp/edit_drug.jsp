        ...
        <div class="col-md-7 col-lg-9">
            ...
            <form action="controller" method="post">
                ...
                <div class="row g-3">
                    ...
                    <div class="row g-2">
                        <div class="col-sm-3">
                            <label for="drugAmount" class="col-form-label"><fmt:message key="editDrug.drugAmount"/>:</label>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-sm-6">
                            <input type="number" class="form-control" id="dosage" name="dosage" value="${editDrug.dosage}" min="0" required>
                        </div>
                    </div>
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-sm-6">
                            <input type="number" class="form-control" id="price" name="price" step="any" value="${editDrug.price}" min="0" required>
                        </div>
                    </div>
                ...
                <div class="form-check">
                    <label class="form-check-label" for="radioButton1"><fmt:message key="editDrug.radioButton.true"/></label>
                    <input class="form-check-input" type="radio" name="needPrescription" id="radioButton1" value="true" ${editDrug.needPrescription==true?'checked':''}>
                </div>
                <div class="form-check">
                    <label class="form-check-label" for="radioButton2"><fmt:message key="editDrug.radioButton.false"/></label>
                    <input class="form-check-input" type="radio" name="needPrescription" id="radioButton2" value="false" ${editDrug.needPrescription!=true?'checked':''}>
                </div>
