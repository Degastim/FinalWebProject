                ...
                <form action="controller" method="POST">
                    <div class="row g-3">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-sm-6">
                                <input type="number" class="form-control" id="drugAmount" name="drugAmount" min="0" required>
                            </div>
                        ...
                        <div class="row g-2">
                            <div class="col-sm-3">
                                <label for="price" class="col-form-label"><fmt:message key="addDrug.price"/>:</label>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="row g-2">
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    <textarea class="form-control" id="drugDescription" name="drugDescription" rows="3" required></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
